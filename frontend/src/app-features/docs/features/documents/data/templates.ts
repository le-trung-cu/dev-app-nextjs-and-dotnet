export const templates = [
  { 
    ...
    imageUrl: "/docs/blank-document.svg",
    initialContent: "",
  },
  { 
    id: "software-proposal", 
    label: "Software development proposal", 
    imageUrl: "/docs/software-proposal.svg",
    initialContent: `
  ...
  { 
    ...
    imageUrl: "/docs/project-proposal.svg",
    initialContent: `
  ...
  { 
    ...
    imageUrl: "/docs/business-letter.svg",
    initialContent: `
  ...
  { 
    id: "cover-letter", 
    label: "Cover letter", 
    imageUrl: "/docs/cover-letter.svg",
    initialContent: `
      <p>[Your Name]<br>
      [Your Address]<br>
      [City, State ZIP]</p>
